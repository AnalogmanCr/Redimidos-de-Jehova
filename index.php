                ...
                <div class="col-12 offset-md-1 col-md-11">
                    <div class="swiper-container hero-slider">
                        <div class="swiper-wrapper">
                            <?php
                            $resultados = new CarrouselDinamico();
                            $arrayResultados =  $resultados->getDatosFull();
                            foreach ($arrayResultados as $registro) :
                            ?>
                                <div class="swiper-slide slide-content d-flex align-items-center">
                                    <div class="single-slide">
                                        <br><br><br><br><br>
                                        <div class="imagenPublicitaria">
                                            <?php
                                            if ($registro->TIPO == 'Imagen') {
                                                echo "<img class='imgHija' src='Galeria/carrousel/$registro->RUTA' alt=$registro->RUTA>";
                                            } else {
                                                $rest = substr($registro->RUTA, 30, strlen($registro->RUTA));
                                                $cadena = $registro->RUTA . "?rel=0&loop=1&playlist=" . $rest;
                                                echo ("<iframe class='VideoHija' src='$cadena' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>");
                                            }
                                            ?>
                                        </div>
                                    </div>
        ...
        <div class="container">
            <div class="text-center cta-content d-xl-flex align-items-center justify-content-around text-xl-left">
                <div class="content" data-aos="fade-right" data-aos-delay="200">
                    <?php
                    if (isset($_SESSION['usuario'])) {
                        echo ("<a class='ConfigNt' href='ConfigCarousel.php'><img alt='login' src='assets/images/ajustes.png' width=32 height=32/>Configurar Noticias</a>");
                    }
                    ?>
                    <h2>ULTIMAS NOTICIAS</h2>
                    <?php
                    $noticia = new CarrouselDinamico();
                    $result = $noticia->GetUltimaNoticia();
                    //echo $result->count();
                    if (isset($result->DESCRIP_ANUNCIO))
                        echo  "<p>" . $result->DESCRIP_ANUNCIO . "</p>";
                    else
                        echo "<p> !No hay anuncios nuevos! </p>"
                ...
                <div class="subscribe-btn" data-aos="fade-left" data-aos-delay="400" data-aos-offset="0">
                    ...
                    if (isset($result->TIPO)) {
                        if ($result->TIPO == "Imagen") {
                            $archivo = "Galeria/carrousel/" . $result->RUTA;
                            echo "<a href='$archivo' target='_blank'><button class='btn btn-primary'>Ir al Evento</button></a>";
                        } else {
                            echo "<a href='$result->RUTA' target='_blank' class='btn btn-primary'>Ir al Evento</a>";
                        }
                    }
            ...
            <div class="row">
                ...
                <div class="col-md-4 gallery">
                    <div class="row no-gutters h-100">
                        <a class="w-50 h-100 gal-img" id="gal-img5" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400" href="galeria.html">
                            <img class="img-fluid img-responsive" src="assets/images/gallery1.jpg" alt="gallery">

                        </a>
                        <a class="w-50 h-50 gal-img gal-img2" data-aos="fade-up" data-aos-delay="400" data-aos-duration="600" href="galeria.html">
                            <img class="img-fluid" src="assets/images/gallery2.jpg" alt="gallery">
                        </a>
                        <a class="w-50 h-50 gal-img gal-img3" data-aos="fade-up" data-aos-delay="0" data-aos-duration="600" href="galeria.html">
    ...
    <section class="pricing-table">
        <div class="container">
            ...
            <div class="row no-gutters">
                <div class="col-md-4">
                    <div class="text-center single-pricing" data-aos="fade-up" data-aos-delay="0" data-aos-duration="600">
                        <span>Semanal</span>
                        <br>
                ...
                <div class="col-md-4">
                    <div class="text-center single-pricing" data-aos="fade-up" data-aos-delay="300" data-aos-duration="600">
                        <span>Semanal</span>
                        <br>
                ...
                <div class="col-md-4">
                    <div class="text-center single-pricing" data-aos="fade-up" data-aos-delay="600" data-aos-duration="600">
                        <span>Semanal</span>
                        <br>
                        ...
                        <div class="text-center swiper-slide">
                            <div class="row">
                                <div class="offset-lg-1 col-lg-9">
                                    <div class="test-img" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0"><img src="assets/images/test1.jpg" alt="Testimonial 1">
                                    </div>
                                    <h5 data-aos="fade-up" data-aos-delay="200" data-aos-duration="600" data-aos-offset="0">Pastor Miguel Castro Cambornero</h5>
                                    <span data-aos="fade-up" data-aos-delay="400" data-aos-duration="600" data-aos-offset="0">PASTOR DE LA IGLESIA LA VICTORIA</span>
                                    <p class="transp" data-aos="fade-up" data-aos-delay="600" data-aos-duration="900" data-aos-offset="0">Fundador de nuestra misión y Pastor Oficial de la Iglesia en la Victoria.</p>
                                </div>
                            </div>
                        </div>
                        <div class="text-center swiper-slide">
                            <div class="row">
                                <div class="offset-lg-1 col-lg-9">
                                    <div class="test-img" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0"><img src="assets/images/pastoramarta.jpg" alt="Testimonial 1"></div>
                                    <h5 data-aos="fade-up" data-aos-delay="200" data-aos-duration="600" data-aos-offset="0">Pastora Marta Porras Porras</h5>
                                    <span data-aos="fade-up" data-aos-delay="400" data-aos-duration="600" data-aos-offset="0">PASTORA IGLESIA EMMANUEL</span>
                                    <p class="transp" data-aos="fade-up" data-aos-delay="600" data-aos-duration="900" data-aos-offset="0">Pastora oficial de Redimidos de Jehová Emmanuel en el Cocal donde sirve con su esposo Miguel</p>
                                </div>
                            </div>
                        </div>
                        <div class="text-center swiper-slide">
                            <div class="row">
                                <div class="offset-lg-1 col-lg-9">
                                    <div class="test-img" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0"><img src="assets/images/roger.jpg" alt="Testimonial 1"></div>
                                    <h5 data-aos="fade-up" data-aos-delay="200" data-aos-duration="600" data-aos-offset="0">Pastor Roger Salazar</h5>
                                    <span data-aos="fade-up" data-aos-delay="400" data-aos-duration="600" data-aos-offset="0">PASTOR DE LA IGLESIA SAN MARTÍN</span>
                                    <p class="transp" data-aos="fade-up" data-aos-delay="600" data-aos-duration="900" data-aos-offset="0">El Pastor Roger es nuestro más reciente miembro del cuerpo
