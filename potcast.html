...
<body>
			   ...
			   <ul class="nav social d-md-flex">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="discografia.html">Música</a></li>
    ...
    <br><br><br><br><br><br><br>
                <div class="container">
                    <div class="title">
                        <br><br><br>
                        <h6 class="title-primary">Potcast</h6>
                        <h1 class="title-white">Audiopredicas</h1>
                    </div>
                    <div class="alinea" >
                    <div class="d-flex flex-row bd-highlight mb-3">
                        <div class="p-2 bd-highlight">    
                            <h6 data-aos="fade-up" data-aos-duration = "800" class="etiqaudio">PROCESADO EN EL DESIERTO <span class="badge badge-secondary">New</span> </h6>
                        </div>
                        <div class="p-2 bd-highlight">
                            <audio data-aos="fade-left" data-aos-duration = "1000" class="audioconf" src="audio/Procesado en el desierto.mp3" preload="auto" controls controlslist="nodownload"></audio>
                        </div>
                      </div>
                    </div>
                </div>   
